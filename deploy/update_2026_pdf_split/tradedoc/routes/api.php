...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        // PDF 自动拆分
        Route::get('/documents/{id}/analyze-split', [DocumentController::class, 'analyzeSplit'])->where('id', '[0-9]+');
        Route::post('/documents/{id}/execute-split', [DocumentController::class, 'executeSplit'])->where('id', '[0-9]+');
